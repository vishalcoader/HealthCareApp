...
//     Here we are create insert the data of cart data by the help of method
...
//    Here we are declare check cart
    ...
    public int checkAppointmentExixts(String username ,String fullname,String address,String contact,String date,String time)
    {
        int result= 0;
